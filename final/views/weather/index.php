...
<div class="container" id="wx">
    ...
    <?php
        ...
        <div class="container">
            <div class="page-header">
                <h1>Weather in <?php echo $weather->current_observation->display_location->full; ?>.</h1>
                <br/>
            </div>
            <h4>Today's
                High: <?php echo $weather->forecast->simpleforecast->forecastdays->forecastday->high->fahrenheit; ?></h4>
            <h4>Today's
                Low: <?php echo $weather->forecast->simpleforecast->forecastdays->forecastday->low->fahrenheit; ?></h4><br/>

            <h4><?php echo $weather->current_observation->weather;?>&nbsp;<img src="<?php echo $weather->current_observation->icon_url;?>"</h4>
            <h4>Temperature Now: <?php echo $weather->current_observation->temperature_string;?></h4>
